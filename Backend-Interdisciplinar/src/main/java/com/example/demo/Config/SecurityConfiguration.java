...
import com.example.demo.FilterToken;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/agenda").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/agenda").hasRole("USER")
                        .requestMatchers(HttpMethod.PUT, "/agenda").hasRole("USER")
                        .requestMatchers(HttpMethod.DELETE, "/agenda/**").hasRole("USER")
